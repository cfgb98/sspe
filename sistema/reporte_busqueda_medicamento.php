...
AND
estatus = 1 ORDER BY idmedicamento ASC";
...
<head>
    ...
    <title>Lista de Medicamentos buscados</title>
</head>
<body>
    <section id="container">
        <h1>Lista de Medicamentos buscados</h1>
        <table>
            <tr>
                <th>ID</th>
                <th>Folio</th>
...
$dompdf->stream("lista_busqueda_medicamentos.pdf", array("Attachment" => false));
